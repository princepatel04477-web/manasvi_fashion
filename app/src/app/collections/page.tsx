      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex gap-3 mb-8">
          <button 
            ...
            className={`rounded-full px-6 py-2.5 font-cormorant text-xs uppercase tracking-widest font-semibold transition-all duration-300 cursor-pointer ${active === "kurti" ? "bg-[#3B2B28] text-[#FAF7F2] shadow-md scale-102" : "bg-white/80 backdrop-blur-sm text-[#3B2B28] border border-[#E7C2B8]/40 hover:border-[#3B2B28]"}`}
          >
            Kurtis
          </button>
          <button 
            onClick={() => setActive("tunic_top")} 
            className={`rounded-full px-6 py-2.5 font-cormorant text-xs uppercase tracking-widest font-semibold transition-all duration-300 cursor-pointer ${active === "tunic_top" ? "bg-[#3B2B28] text-[#FAF7F2] shadow-md scale-102" : "bg-white/80 backdrop-blur-sm text-[#3B2B28] border border-[#E7C2B8]/40 hover:border-[#3B2B28]"}`}
          >
            Tunic Tops
          </button>
        </div>
