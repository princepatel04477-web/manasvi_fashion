...
import { Bodoni_Moda, Cormorant_Garamond, DM_Serif_Display, IM_Fell_Great_Primer, Inter, Playfair_Display, Jost } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" className={`${playfair.variable} ${imFell.variable} ${cormorant.variable} ${dm.variable} ${inter.variable} ${jost.variable} ${bodoni.variable} ${grance.variable}`} suppressHydrationWarning>
