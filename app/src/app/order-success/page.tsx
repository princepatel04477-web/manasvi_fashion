    ...
    return (
      <div className="max-w-md mx-auto text-center py-16 px-4 bg-white/60 backdrop-blur-md rounded-3xl border border-[#E7C2B8]/30 warm-shadow">
        ...
        <p className="font-inter text-xs text-[#8B6B61] mb-6 leading-relaxed">
          {error || "We could not find matching order details."}
        </p>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="rounded-2xl border border-[#E7C2B8]/40 bg-white/80 backdrop-blur-md p-8 sm:p-10 warm-shadow text-center relative overflow-hidden">
          ...
          {/* Strict output tags */}
          <div className="space-y-2 text-center text-xs text-[#8B6B61] max-w-md mx-auto mb-4 font-light">
            <p className="text-base text-[#3B2B28] font-cormorant">
              Order Number: <strong className="font-semibold text-[#3B2B28]">{order.id}</strong>
            </p>
            <p className="text-lg text-[#3B2B28] font-cormorant">
              Amount Paid: <strong className="font-semibold text-[#3B2B28]">{formatINR(total)}</strong>
            </p>
          </div>
          
          <p className="font-inter text-xs text-[#8B6B61] leading-relaxed max-w-md mx-auto font-light mt-4">
            Thank you for shopping with <strong className="font-semibold text-[#3B2B28]">MANASVI FASHION</strong>. A receipt has been dispatched to <span className="font-medium text-[#3B2B28]">{order.customerEmail}</span>.
          </p>
        </div>
